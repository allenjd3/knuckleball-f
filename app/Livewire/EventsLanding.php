...
class EventsLanding extends Component
{
    ...
    public function updatedFilter(): void { $this->resetPage(); unset($this->events); }
    public function updatedDateFrom(): void { $this->resetPage(); unset($this->events); }
    public function updatedDateTo(): void { $this->resetPage(); unset($this->events); }
