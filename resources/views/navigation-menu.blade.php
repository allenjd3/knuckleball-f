        ...
        <div class="flex justify-between h-16">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('players.index') }}" class="font-bold">
                        ...
                        <h3 style="--c-600: var(--primary-600)" class="text-lg tracking-tight text-custom-600">Knuckleball</h3>
                    </a>
                </div>
                ...
                <div class="flex">
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link href="{{ route('users.feed') }}" :active="request()->routeIs('users.feed')">
                            {{ __('Feed') }}
                        </x-nav-link>
